...
```
git clone https://github.com/<YOUR GITHUB USERNAME>/K-Verse-MAIN.git
...
### Then, Customize data in the `utils/data` [folder](https://github.com/BVPKARTHIJEYA/K-Verse-MAIN/tree/main/utils/data).
...
export const personalData = {
  ...
  description: "My name is Karthikeya Boddeda...",
